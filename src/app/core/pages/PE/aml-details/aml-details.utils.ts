...
export function prepareAmlDetails(applicationDetails: IApplicationDetails | null): IAmlDetails {
  ...
  return {
    ...
    payerName: payment.paymentApplication.payer.user?`${payment.paymentApplication.payer.user.naturalSurname} ${payment.paymentApplication.payer.user.naturalName} ${payment.paymentApplication.payer.user.naturalPatronymic}`:'',
    payerAccount: payment.paymentApplication.payer.requisites?.account??'',
    payeeName: payment.paymentApplication.payee.user?`${payment.paymentApplication.payee.user.naturalSurname} ${payment.paymentApplication.payee.user.naturalName} ${payment.paymentApplication.payee.user.naturalPatronymic}`:'',
