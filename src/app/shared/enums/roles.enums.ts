...
export enum ProdRolesList {
  // AP_ABS_ADMIN= "AP.ABS_ADMIN",
  // AP_BranchUsers= "AP.BranchUsers",
  // AP_CSD_CCI_Report= "AP.CSD_CCI_Report",
  // AP_CSD_CCI_VIP= "AP.CSD_CCI_VIP",
  // AP_CSD_DSI= "AP.CSD_DSI",
  // AP_CSD_DSI_VIP= "AP.CSD_DSI_VIP",
  // CSD_CCI= "CSD_CCI",
