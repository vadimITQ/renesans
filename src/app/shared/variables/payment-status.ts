export const paymentStatusObj: any = {
  ...
  '830': 'Отмена платежа по итогам автопроверки BankOps',
  '850': 'Отмена по итогам автопроверки AntiFraud',
  '855': 'Системная ошибка на этапе автоматических проверок',
  '856': 'Ожидание ответа от SAS по AniFraud проверкам',
  ...
  '880': 'Не пройдены ручные проверки AML/AniFraud/BankOps',
...
export const paymentStatuses: any = [
  ...
  { value: '830', label: '(830) Отмена платежа по итогам автопроверки BankOps' },
  { value: '850', label: '(850) Отмена по итогам автопроверки AntiFraud' },
  { value: '856', label: '(856) Ожидание ответа от SAS по AniFraud проверкам' },
  ...
  { value: '880', label: '(880) Не пройдены ручные проверки AML/AniFraud/BankOps' },
  ...
  { value: '811', label: '(811) Платеж на обработке в СБП' },
